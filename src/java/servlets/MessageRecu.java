        ...
        try {
            ...
            if(idMembre==0)
                ...
                if(request.getParameter("idMessage")==null)
                    ...
                    message.initMsgRecu(idMessage, idMembre);
                    if(message.getId()==0)
                        request.setAttribute("info", 2);
                    else {
                        if(request.getParameter("kermit")!=null) {
                            ...
                            message.enregMsgRecu(request);
                        }
                        request.setAttribute("message", message);
                    }
                }
            }
            RequestDispatcher dispatch = request.getRequestDispatcher("/WEB-INF/scripts/messagerecu.jsp");
