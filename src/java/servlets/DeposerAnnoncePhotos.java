        ...
        try {
            ...
            if(idMembre==0)
                ...
                if(session.getAttribute("idAnnonce")==null)
                    ...
                    AnnoncePhotos annonce=new AnnoncePhotos(idAnnonce, membre);
                    annonce.initAnnonce();
                    if(annonce.getId()==0)
                        request.setAttribute("info", 2);
                    else
            ...
            RequestDispatcher dispatch = getServletContext().getRequestDispatcher("/WEB-INF/scripts/deposerannoncephotos.jsp");
