...
public class Datas {
    ...
    public static final String URLROOT="http://www.sitededons.net";
    public static final String DIR="/var/datas/don/";
    public static final String TITRESITE="Don & recupe";
    ...
    public static final String[] arrayReplace2={"","et","-","-","e","e","e","e","a","u","o","o","-","","-", "-"};
    ...
    public static final int NBINDEX=6;
    public static final String[] MOTSCLESOUT={"don", "dons", "donne", "donnes", "donnons", "donnez", "recupe", "recup", "recherche", "recherches", "recherchons", "cherche", "cherches", "cherchons"};
}
